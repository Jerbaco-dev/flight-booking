...
namespace Jerbaco.Flights
{
    public static class SeedService
    {
        public static void Seeding(WebApplication webApplication)
        {
            var entities = webApplication.Services.CreateScope().ServiceProvider.GetService<Entities>();
